...
Процедура ОтправитьПисьмо()
	Попытка
		ОписаниеДляПисьма = ?(ПустаяСтрока(Описание),БизнесПроцесс.Наименование,Описание); 
	Исключение
		ОписаниеДляПисьма = "";
	КонецПопытки;
	Текст = "";
	...
	Текст = Текст  + "Описание: "+ОписаниеДляПисьма + Символы.ПС;
	Текст = Текст  + "Предмет: "+БизнесПроцесс.Предмет + Символы.ПС;
