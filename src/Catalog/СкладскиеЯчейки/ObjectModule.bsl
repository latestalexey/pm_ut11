...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоГруппа Тогда
		...
		Если ТипСкладскойЯчейки <> Перечисления.ТипыСкладскихЯчеек.Хранение
			...
			Или СкладыСервер.ИспользоватьАдресноеХранениеСправочно(Владелец, Помещение) Тогда
			...
			Если СкладыСервер.ИспользоватьАдресноеХранениеСправочно(Владелец, Помещение) Тогда
