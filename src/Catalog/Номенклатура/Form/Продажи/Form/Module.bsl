...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		НоменклатураПродаваемаяСовместноСДанной.Отбор, 
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		НоменклатураСКоторойПродаетсяСовместноДанная.Отбор, 
	...
	СформироватьОтчет("ВыручкаИСебестоимостьПродаж");
...
&НаКлиенте
Процедура СформироватьОтчетВыручкаИСебестоимостьПродаж(Команда)
	
	ОбновитьОтчет("ВыручкаИСебестоимостьПродаж");
...
Процедура ОбновитьОтчет(ИмяОтчета)
	...
	Если ИмяОтчета = "ВыручкаИСебестоимостьПродаж" Тогда
...
&НаКлиенте
Процедура ТаблицаОтчетаВыручкаИСебестоимостьПродажОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
...
Процедура ОбработатьРасшифровкуОтчетаВыручкаИСебестоимостьПродаж(ОписаниеОбработкиРасшифровки)
	...
	ИмяОтчета = "ВыручкаИСебестоимостьПродаж";
