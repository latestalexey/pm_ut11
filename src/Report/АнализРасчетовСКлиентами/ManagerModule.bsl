...
///////////////////////////////////////////////////////////////////////////////
// Управление видимостью, важностью и зависимостями от функциональных опций
//
...
Процедура ПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка) Экспорт
	...
	// Создание команды
	КомандаАктуализироватьРасчеты = Команды.Добавить("АктуализироватьРасчетыСКлиентами");
	...
	КомандаАктуализироватьРасчеты.Подсказка = НСтр("ru= 'Актуализировать расчеты с клиентами.'");
	
	ПостоянныеКоманды.Добавить("АктуализироватьРасчетыСКлиентами");
	
	// Добавление кнопки вызова команды
	КнопкаАктуализироватьРасчеты = Элементы.Вставить("АктуализироватьРасчетыСКлиентами", Тип("КнопкаФормы"), Элементы.ЛеваяЧастьКоманднойПанели, Элементы.КнопкиТабличногоДокумента);
	КнопкаАктуализироватьРасчеты.ИмяКоманды = "АктуализироватьРасчетыСКлиентами";
...
//
// Подробнее - см. ФормаОтчетаПереопределяемый.КонтекстныйВызовСервера
//
