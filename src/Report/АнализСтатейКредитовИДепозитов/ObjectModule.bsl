...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Для Каждого  ЭлементВыбора Из НастройкиОтчета.Выбор.Элементы Цикл
		...
		Если Не ТипЗнч(ЭлементВыбора) = Тип("ВыбранноеПолеКомпоновкиДанных") Тогда
			Если Найти(ЭлементВыбора.Заголовок,"упр") > 0 Тогда
				ЭлементВыбора.Заголовок = "Валюта упр. (" + ВалютаУпрУчета + ")";
				ЭлементВыбора.Использование = НЕ ВалютыСовпадают;
			ИначеЕсли Найти(ЭлементВыбора.Заголовок,"регл") > 0 Тогда
				ЭлементВыбора.Заголовок = "Валюта регл. (" + ВалютаРеглУчета + ")";
			КонецЕсли;
		КонецЕсли;
