...
Процедура Настройки(Команда)
	...
	Результат = ОткрытьФормуМодально("Отчет.СравнительныйАнализПоказателейРаботыМенеджеров.Форма.ВыборНастроек",ПараметрыДляФормыНастроек,ЭтаФорма);
...
Процедура ЗаполнитьДеревоНаборовДанных()
	...
	ДобавленнаяСтрока = НовыйЭлементДерева(ДеревоНастроек,"ПродажиПрибыльВыручка","Продажи, прибыль, выручка",Истина);
	...
	ДобавленнаяСтрока = НовыйЭлементДерева(ДеревоНастроек,"СоблюдениеУсловийПродаж","Соблюдение условий продаж",Истина);
	...
	ДобавленнаяСтрока = НовыйЭлементДерева(ДеревоНастроек,"ЭффективностьРаботы","Эффективность работы",ИспользоватьСделкиСКлиентами ИЛИ ИспользоватьВзаимодействия);
	...
	ДобавленнаяСтрока = НовыйЭлементДерева(ДеревоНастроек,"ПричиныПотерь","Причины потерь",ИспользоватьСделкиСКлиентами ИЛИ ФиксироватьПервичныйИнтерес);
	...
	ДобавленнаяСтрока = НовыйЭлементДерева(ДеревоНастроек,"ПривлечениеУдержаниеКлиентов","Привлечение и удержание клиентов",ИспользуетсяКлассификацияПартнеров);
	...
	ДобавленнаяСтрока = НовыйЭлементДерева(ДеревоНастроек,"ПоддержкаЛояльностиКлиентов","Поддержка лояльности клиентов",ФиксироватьПретензииКлиентов);
