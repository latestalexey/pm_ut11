...
Функция ТекстЗапросаОУчастиеПартнераВПрочихПроектах(СоответствиеЗапросыДанные,НомерПоследнегоПакета)
	...
	Если НЕ ПравоДоступа("Чтение",Метаданные.Справочники.МаркетинговыеМероприятия) И НЕ ПравоДоступа("Чтение",Метаданные.Справочники.Проекты) Тогда
		Возврат "";
	КонецЕсли;
...
Функция ТекстЗапросаОЗаказахПоставщику(СоответствиеЗапросыДанные,НомерПоследнегоПакета)
	...
	Если НЕ ПравоДоступа("Чтение",Метаданные.Документы.ЗаказПоставщику) ИЛИ
		НЕ ПравоДоступа("Чтение",Метаданные.РегистрыНакопления.РасчетыСПоставщиками) ИЛИ
	...
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказовПоставщикам.ОжидаетсяСогласование)
	|		КОГДА ДокументЗаказПоставщику.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Закрыт)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказовПоставщикам.Закрыт)
	|		КОГДА ДокументЗаказПоставщику.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Согласован)
	...
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказовПоставщикам.ОжидаетсяАвансДоПодтверждения)
	|		КОГДА ДокументЗаказПоставщику.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Согласован)
	|				И ДокументЗаказПоставщику.СуммаДокумента > 0
	|				И ЕСТЬNULL(РасчетыСПоставщикамиОстатки.КОплатеПриход, 0) >= ДокументЗаказПоставщику.СуммаАвансаДоПодтверждения
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказовПоставщикам.ОжидаетсяПодтверждение)
	|		КОГДА (ДокументЗаказПоставщику.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Согласован)
	...
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказовПоставщикам.ОжидаетсяПредоплатаДоПоступления)
	|		КОГДА ДокументЗаказПоставщику.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Подтвержден)
	|				И ДокументЗаказПоставщику.СуммаДокумента > 0
	|				И ЕСТЬNULL(РасчетыСПоставщикамиОстатки.КОплатеПриход, 0) >= ДокументЗаказПоставщику.СуммаПредоплатыДоПоступления + ДокументЗаказПоставщику.СуммаАвансаДоПодтверждения
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказовПоставщикам.ОжидаетсяПоступление)
	|		КОГДА ДокументЗаказПоставщику.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.КПоступлению)
	...
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказовПоставщикам.ОжидаетсяОплатаПослеПоступления)
	|		КОГДА ДокументЗаказПоставщику.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Закрыт)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказовПоставщикам.ГотовКЗакрытию)
	|	КОНЕЦ КАК Состояние,
	|	ВЫБОР
	|		КОГДА (НЕ ДокументЗаказПоставщику.Проведен)
	|			ТОГДА ЛОЖЬ
	...
	|				И ДокументЗаказПоставщику.ДатаПервогоПоступления < &ТекущаяДата
	|			ТОГДА ИСТИНА
	|		КОГДА ДокументЗаказПоставщику.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Подтвержден)
	|				И ДокументЗаказПоставщику.СуммаПредоплатыДоПоступления > 0
	|				И ЕСТЬNULL(РасчетыСПоставщикамиОстатки.КОплатеПриход, 0) < ДокументЗаказПоставщику.СуммаПредоплатыДоПоступления + ДокументЗаказПоставщику.СуммаАвансаДоПодтверждения
	...
	|						И ЗаказПоставщику.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Закрыт))) КАК РасчетыСПоставщикамиОстатки
	...
	|						ЗаказПоставщику.Проведен
	|						И ЗаказПоставщику.Партнер = &Партнер
	|						И ЗаказПоставщику.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Закрыт))) КАК РасчетыСПоставщикамиОстаткиНаДатуАктуальности
	...
	|	И ДокументЗаказПоставщику.Партнер = &Партнер
	|	И ДокументЗаказПоставщику.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Закрыт)
	|ИТОГИ
	|	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ Ссылка),
	|	СУММА(СуммаДокумента)
	|ПО
...
Функция ТекстЗапросаОЗаказахПартнера(СоответствиеЗапросыДанные,НомерПоследнегоПакета)
	...
	Если НЕ ПравоДоступа("Чтение",Метаданные.Документы.ЗаказКлиента) ИЛИ
		 НЕ ПравоДоступа("Чтение",Метаданные.РегистрыНакопления.РасчетыСКлиентами) ИЛИ
	...
	|						И ДокументЗаказКлиента.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовКлиентов.Закрыт))) КАК РасчетыСКлиентамиОстатки
	...
	|						ДокументЗаказКлиента.Проведен
	|						И ДокументЗаказКлиента.Партнер = &Партнер
	|						И ДокументЗаказКлиента.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовКлиентов.Закрыт))) КАК РасчетыСКлиентамиОстаткиНаДатуАктуальности
	|		ПО ДокументЗаказКлиента.Ссылка = РасчетыСКлиентамиОстаткиНаДатуАктуальности.ЗаказКлиента
	|ГДЕ
	|	ДокументЗаказКлиента.Проведен
	|	И ДокументЗаказКлиента.Партнер = &Партнер
	|	И ДокументЗаказКлиента.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовКлиентов.Закрыт)
	|ИТОГИ
	|	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ Ссылка),
	|	СУММА(СуммаДокумента)
	|ПО
...
Функция ТекстЗапросаОВзаиморасчетахСКлиентом(СоответствиеЗапросыДанные,НомерПоследнегоПакета)
	...
	Если Не ЗначениеЗаполнено(ВариантКлассификацииЗадолженности) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='В настройках параметров учета не указан основной вариант классификации задолженностей. Данные о взаиморасчетах с клиентом не выведены'"));
		 Возврат "";
	КонецЕсли;
	
	СоответствиеЗапросыДанные.Вставить("ВзаиморасчетыСКлиентом",НомерПоследнегоПакета + 7);
	...
	|	МАКСИМУМ(
	|		ДОБАВИТЬКДАТЕ(Границы.АктуальныйПериод, ДЕНЬ, -1)
	|	) КАК АктуальныйПериод,
	...
	|ГДЕ
	|	ГрафикиРаботы.ДатаГрафика МЕЖДУ ТаблицаЗадолженностей.ДатаПлатежа И &ТекущаяДата
...
Функция ТекстЗапросаОВзаиморасчетахСПоставщиком(СоответствиеЗапросыДанные,НомерПоследнегоПакета)
	...
	Если Не ЗначениеЗаполнено(ВариантКлассификацииЗадолженности) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='В настройках параметров учета не указан основной вариант классификации задолженностей. Данные о взаиморасчетах с поставщиком не выведены'"));
		 Возврат "";
	КонецЕсли;
	
	СоответствиеЗапросыДанные.Вставить("ВзаиморасчетыСПоставщиком",НомерПоследнегоПакета + 7);
	НомерПоследнегоПакета = НомерПоследнегоПакета + 7;
	...
	|	(
	|		ВЫБРАТЬ
	|			НачальныеДвиженияПоставщики.АналитикаУчетаПоПартнерам КАК АналитикаУчетаПоПартнерам,
	|			ЕСТЬNULL(ПроведениеПоРасчетамСПоставщикамиГраницы.Период, НачальныеДвиженияПоставщики.Период) КАК АктуальныйПериод
	|		ИЗ
	|			НачальныеДвиженияПоставщики КАК НачальныеДвиженияПоставщики
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ
	|			Последовательность.ПроведениеПоРасчетамСПоставщиками.Границы КАК ПроведениеПоРасчетамСПоставщикамиГраницы
	|				ПО НачальныеДвиженияПоставщики.АналитикаУчетаПоПартнерам = ПроведениеПоРасчетамСПоставщикамиГраницы.АналитикаУчетаПоПартнерам
	|	) КАК Границы
	|		
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		РегистрНакопления.РасчетыСПоставщиками КАК РасчетыСПоставщиками
	|	ПО
	|		Границы.АналитикаУчетаПоПартнерам = РасчетыСПоставщиками.АналитикаУчетаПоПартнерам
	|
	|СГРУППИРОВАТЬ ПО
	|	Границы.АналитикаУчетаПоПартнерам
	|
...
КонецФункции // ПолучитьТекстЗапросаОВзаиморасчетахСПоставщиком()

Функция ТекстЗапросаОДоступныхСоглашениях(СоответствиеЗапросыДанные,НомерПоследнегоПакета)
	
	Если НЕ ПравоДоступа("Чтение",Метаданные.Справочники.СоглашенияСКлиентами) Тогда
		Возврат "";
	КонецЕсли;
...
Функция ТекстЗапросаОКлассификацииКлиента(СоответствиеЗапросыДанные,НомерПоследнегоПакета)
	...
	СоответствиеЗапросыДанные.Вставить("КлассификацияКлиента",НомерПоследнегоПакета + 3);
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	МАКСИМУМ(ПериодыКлассификации.Период) КАК ТекущийПериод,
	|	ВЫБОР
	|		КОГДА МИНИМУМ(ПериодыКлассификации.Период) = МАКСИМУМ(ПериодыКлассификации.Период)
	|			ТОГДА NULL
	|		ИНАЧЕ МИНИМУМ(ПериодыКлассификации.Период)
...
Функция ВыполнитьПакетЗапросовПоПартнеру(Партнер,СоответствиеЗапросыДанные)
	...
	ВариантКлассификацииЗадолженности = ВариантКлассификацииЗадолженности;
...
Процедура ВывестиДанныеПартнера(РезультатЗапросаПоРеквизитамПартнера,РезультатЗапросаПоДополнительнымРеквизитам,РезультатЗапросаПервичныйИнтерес,ТаблицаОтчета,Макет)
	...
	ВывестиОбластьБезПараметров("ПустаяСтрока",Макет,ТаблицаОтчета);
	ВывестиЗаголовокПодраздела(Макет,ТаблицаОтчета,"Данные партнера");
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПартнеровКакКонтрагентов") Тогда
		...
		Область.Параметры.ИНН_КПП   = ВыборкаРеквизитыПартнера.ИНН + ?(ПустаяСтрока(ВыборкаРеквизитыПартнера.КПП),"","/" + ВыборкаРеквизитыПартнера.КПП);
		ТаблицаОтчета.Вывести(Область,2);
...
Процедура ВывестиДанныеОВышестоящихПартнерах(РезультатЗапросаПоВышестоящимПартнерам,ТаблицаОтчета,Макет)
	...
	ВывестиОбластьБезПараметров("ПустаяСтрока",Макет,ТаблицаОтчета);
	ВывестиЗаголовокПодраздела(Макет,ТаблицаОтчета,СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Вышестоящие партнеры - %1 '"),ВыборкаИтоги.Ссылка));
...
Процедура ВывестиДанныеОКонтрагентах(РезультатЗапросаПоКонтрагентам,ТаблицаОтчета,Макет)
	...
	ВыборкаИтоги.Следующий();
	ВывестиОбластьБезПараметров("ПустаяСтрока",Макет,ТаблицаОтчета);
	ВывестиЗаголовокПодраздела(Макет,ТаблицаОтчета,СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Контрагенты - %1.'"),ВыборкаИтоги.Ссылка));
...
Процедура ВывестиДанныеОбороты(РезультатЗапросаОбороты, ТаблицаОтчета, Макет);
	...
	ВывестиОбластьБезПараметров("ПустаяСтрока",Макет,ТаблицаОтчета);
	ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Общий объём выручки от продаж клиенту : %1 %2.'"), ВыборкаИтоги.СуммаВыручкиОборот,ВыборкаИтоги.Валюта);
	ВывестиЗаголовокПодраздела(Макет,ТаблицаОтчета,ТекстЗаголовка);
...
Процедура ВывестиДанныеОСоглашенияхСПоставщиком(РезультатЗапросаПоСоглашениям,ТаблицаОтчета, Макет)
	...
	ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Доступно соглашений с поставщиком - %1.'"),ВыборкаИтоги.Ссылка);
	ВывестиЗаголовокПодраздела(Макет,ТаблицаОтчета,ТекстЗаголовка);
...
Процедура ВывестиДанныеОНеотработанныхВзаимодействиях(РезультатЗапросаПоВзаимодействиям,ТаблицаОтчета, Макет)
	...
	ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Неотработанных взаимодействий - %1'"),ВыборкаИтоги.Ссылка);
	ВывестиЗаголовокПодраздела(Макет,ТаблицаОтчета,ТекстЗаголовка);
...
Процедура ВывестиДанныеОЗаказахПартнера(РезультатЗапросаПоЗаказам,ТаблицаОтчета, Макет,ТипЗаказов)
	...
	ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='В работе заказов %1 - %2'"),ТипЗаказов,ВсегоЗаказов);
	...
	Пока ВыборкаВалюты.Следующий() Цикл
		...
		Иначе
			ТекстЗаголовка =  ТекстЗаголовка + ?(ПерваяВалюта,НСтр("ru=', в том числе '"),"") + 
			                                     СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru=' %1 заказ(ов) на сумму %2 %3, '"),ВыборкаВалюты.Ссылка,ВыборкаВалюты.СуммаДокумента,ВыборкаВалюты.Валюта);
			ПерваяВалюта =  Ложь;
		КонецЕсли;
...
Процедура ВывестиДанныеОДействующихКоммерческихПредложениях(РезультатЗапросаПоКоммерческимПредложениям,ТаблицаОтчета,Макет)
	...
	Пока ВыборкаВалюты.Следующий() Цикл
		...
		Если ВыборкаВалюты.Ссылка = ВсегоЗаказов Тогда
			ТекстЗаголовка =  ТекстЗаголовка + СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru=' на сумму %2 %3, '"),ВыборкаВалюты.СуммаДокумента,ВыборкаВалюты.Валюта);
		Иначе
			ТекстЗаголовка =  ТекстЗаголовка + ?(ПерваяВалюта,НСтр("ru=', в том числе '"),"") + 
...
Процедура ВывестиДанныеНезавершенныеПретензии(РезультатЗапросаНезавершенныеПретензии,ТаблицаОтчета, Макет)
	...
	ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Незавершенных претензий - %1.'"),ВыборкаИтоги.Ссылка);
...
Процедура ВывестиДанныеОВзаиморасчетахСКлиентом(РезультатЗапросаПоВзаиморасчетам,ТаблицаОтчета, Макет)
	...
	Пока ВыборкаВалюты.Следующий() Цикл
		...
		Если ВыборкаВалюты.ДолгКлиентаПросрочено <> 0 Тогда
			СтрокаПросроченнаяЗадолженность = СтрокаПросроченнаяЗадолженность  + ВыборкаВалюты.ДолгКлиентаПросрочено + " " + ВыборкаВалюты.Валюта + ", ";
		КонецЕсли;
	...
	Если НЕ ПустаяСтрока(СтрокаПросроченнаяЗадолженность) Тогда
		...
		СтрокаПросроченнаяЗадолженность = НСтр("ru='В том числе просроченная задолженность '") + Лев(СтрокаПросроченнаяЗадолженность,СтрДлина(СтрокаПросроченнаяЗадолженность)-2) + ".";
	...
	Пока ВыборкаВалюты.Следующий() Цикл
		...
		Пока ВыборкаДетали.Следующий() Цикл
			...
			КонецЕсли;
			Если ВыборкаДетали.НаименованиеИнтервала = "Расчеты не актуальны" Тогда
...
Процедура ВывестиДанныеОВзаиморасчетахСПоставщиком(РезультатЗапросаПоВзаиморасчетам,ТаблицаОтчета, Макет)
	...
	СтрокаДолгПередПоставщиком = НСтр("ru='Общая задолженность перед поставщиком '") + Лев(СтрокаДолгПередПоставщиком,СтрДлина(СтрокаДолгПередПоставщиком)-2) + ".";
...
Процедура ВывестиДанныеОКлассификацииКлиента(РезультатЗапросаПоКлассификации,РезультатЗапросаПериоды,ТаблицаОтчета, Макет)
	...
	Область.Параметры.ПредыдущийПериод	= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1 (%2)'"),Формат(ВыборкаПериоды.ПредыдущийПериод,"ДФ=dd.MM.yyyy"),ПериодКлассификации);
	Область.Параметры.ТекущийПериод		= СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1 (%2)'"),Формат(ВыборкаПериоды.ТекущийПериод,"ДФ=dd.MM.yyyy"),ПериодКлассификации);
	ТаблицаОтчета.Вывести(Область);
	...
	Пока ВыборкаТипПараметра.Следующий() Цикл
		...
		Если ВыборкаТипПараметра.ТипПараметраКлассификации = Перечисления.ТипыПараметровКлассификации.Выручка ИЛИ
			...
			ТекстПараметрКлассификации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1 (%2)'"),Строка(ВыборкаТипПараметра.ТипПараметраКлассификации),ВалютаУправленческогоУчета);
		...
		Пока ВыборкаДетали.Следующий() Цикл
			Если ВыборкаДетали.СтрокаПериод = "Текущий" Тогда
				Если (Не ВыборкаДетали.Класс = Перечисления.ABCКлассификация.НеКлассифицирован) И (Не ВыборкаДетали.Класс = Перечисления.XYZКлассификация.НеКлассифицирован) Тогда
...
Процедура ВывестиДанныеОДоговорахКонтрагентов(РезультатЗапросаПоДоговорам,ТаблицаОтчета, Макет)
	...
	ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Действующих договоров с контрагентами - %1.'"),ВыборкаИтоги.Ссылка);
	ВывестиЗаголовокПодраздела(Макет,ТаблицаОтчета,ТекстЗаголовка);
	
	//Вывод таблицы
	ТаблицаОтчета.НачатьГруппуСтрок("ДоговорыКонтрагентов");
	ВывестиОбластьБезПараметров("ДоговорыКонтрагентовШапка",Макет,ТаблицаОтчета);
	
	ЧетнаяСтрока = Ложь;
	ВыборкаДетали = ВыборкаИтоги.Выбрать();
	Пока ВыборкаДетали.Следующий() Цикл
	
		Область = Макет.ПолучитьОбласть("ДоговорыКонтрагентовСтрока");
		ЗаполнитьЗначенияСвойств(Область.Параметры, ВыборкаДетали);
		Если ЧетнаяСтрока Тогда
...
Процедура СформироватьОтчет(ТаблицаОтчета, Партнер)  Экспорт
	...
	Если СоответствиеЗапросыДанные["ДанныеПартнера"] <> Неопределено Тогда
		ВывестиДанныеПартнера(МассивРезультатовЗапросовПоПартнеру[0],МассивРезультатовЗапросовПоПартнеру[1],?(СоответствиеЗапросыДанные["ПервичныйИнтерес"]=Неопределено,Неопределено,МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["ПервичныйИнтерес"]]),ТаблицаОтчета,Макет);
	КонецЕсли;
	...
	Если Контакты Тогда
		...
		Если СоответствиеЗапросыДанные["ВышестоящиеПартнеры"] <> Неопределено Тогда
			ВывестиДанныеОВышестоящихПартнерах(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["ВышестоящиеПартнеры"]],ТаблицаОтчета,Макет);
		КонецЕсли;
	...
	Если ДанныеКлиента Тогда
		Если СоответствиеЗапросыДанные["ВзаиморасчетыСКлиентом"] <> Неопределено Тогда
			ВывестиДанныеОВзаиморасчетахСКлиентом(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["ВзаиморасчетыСКлиентом"]],ТаблицаОтчета, Макет);
		КонецЕсли;
	КонецЕсли;
	Если ДанныеПоставщика Тогда
		Если СоответствиеЗапросыДанные["ВзаиморасчетыСПоставщиком"] <> Неопределено Тогда
			ВывестиДанныеОВзаиморасчетахСПоставщиком(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["ВзаиморасчетыСПоставщиком"]],ТаблицаОтчета, Макет);
		КонецЕсли;
	КонецЕсли;
	Если ДанныеКлиента ИЛИ ДанныеПоставщика Тогда
		Если СоответствиеЗапросыДанные["ДоговорыКонтрагентов"] <> Неопределено Тогда
			ВывестиДанныеОДоговорахКонтрагентов(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["ДоговорыКонтрагентов"]],ТаблицаОтчета, Макет);
		КонецЕсли;
	КонецЕсли;
	Если ДанныеКлиента Тогда
		Если СоответствиеЗапросыДанные["НезавершенныеПретензии"] <> Неопределено Тогда
			ВывестиДанныеНезавершенныеПретензии(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["НезавершенныеПретензии"]],ТаблицаОтчета, Макет);
		КонецЕсли;
		...
		Если СоответствиеЗапросыДанные["ДоступныеСоглашения"] <> Неопределено Тогда
			ВывестиДанныеОДоступныхСоглашениях(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["ДоступныеСоглашения"]],ТаблицаОтчета, Макет);
		КонецЕсли;
		...
		Если СоответствиеЗапросыДанные["Заказы"] <> Неопределено Тогда
			ВывестиДанныеОЗаказахПартнера(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["Заказы"]],ТаблицаОтчета, Макет, НСтр("ru='клиента'"));
		КонецЕсли;
	КонецЕсли;
	Если ДанныеПоставщика Тогда
		Если СоответствиеЗапросыДанные["СоглашенияСПоставщиком"] <> Неопределено Тогда
			ВывестиДанныеОСоглашенияхСПоставщиком(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["СоглашенияСПоставщиком"]],ТаблицаОтчета, Макет);
		КонецЕсли;
		Если СоответствиеЗапросыДанные["ЗаказыПоставщику"] <> Неопределено Тогда
			ВывестиДанныеОЗаказахПартнера(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["ЗаказыПоставщику"]],ТаблицаОтчета, Макет,НСтр("ru='поставщику'"));
		КонецЕсли;
	КонецЕсли;
	Если ТекущаяАктивность Тогда
		Если СоответствиеЗапросыДанные["НеотработанныеВзаимодействия"] <> Неопределено Тогда
			ВывестиДанныеОНеотработанныхВзаимодействиях(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["НеотработанныеВзаимодействия"]],ТаблицаОтчета, Макет);
		КонецЕсли;
		Если СоответствиеЗапросыДанные["УчастиеВСделках"] <> Неопределено Тогда
			ВывестиДанныеОСделкахСУчастиемПартнера(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["УчастиеВСделках"]],МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["УчастиеВСделках"]+1],ТаблицаОтчета, Макет);
		КонецЕсли;
		Если СоответствиеЗапросыДанные["ПрочиеПроекты"] <> Неопределено Тогда
			ВывестиДанныеОУчастиеПартнераВПрочихПроектах(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["ПрочиеПроекты"]],МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["ПрочиеПроекты"]+1],ТаблицаОтчета, Макет);
		КонецЕсли;
	КонецЕсли;
	Если Классификация Тогда
		Если СоответствиеЗапросыДанные["КлассификацияКлиента"] <> Неопределено Тогда
			ВывестиДанныеОКлассификацииКлиента(МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["КлассификацияКлиента"]],МассивРезультатовЗапросовПоПартнеру[СоответствиеЗапросыДанные["КлассификацияКлиента"]+1],ТаблицаОтчета, Макет);
		КонецЕсли;
