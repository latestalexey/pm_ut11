...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтандартныеПодсистемыПереопределяемый.ОпределитьЗаписиПоИндексу(Параметры.Индекс, НайденоПоИндексу);
...
Функция ОбработатьРезультатПоискаПоИндексу(КодАдресногоЭлемента)
	...
	Иначе
		СтандартныеПодсистемыПереопределяемый.ПоКодуАдресногоЭлементаВСтруктуруПолучитьЕгоКомпоненты(
		...
		СтруктураАдреса = УправлениеКонтактнойИнформацией.ПолучитьПустуюСтруктуруАдреса();;
		СтандартныеПодсистемыПереопределяемый.ОпределитьСтруктуруАдреса(СтруктураАдреса, КодАдресногоЭлемента);
	КонецЕсли;
...
Функция ЗагруженныеПоляПоРегиону(СтруктураАдреса)
	...
	РегионЗагружен = Ложь;
	СтандартныеПодсистемыПереопределяемый.ОпределитьЗагруженностьАдресногоЭлемента(РегионЗагружен, СтруктураАдреса.Регион);
