...
Функция ПроверитьСоответствиеАдресаКЛАДРу(УказанныйИндекс = "", НазваниеРегиона = "", НазваниеРайона = "",
	...
	СтандартныеПодсистемыПереопределяемый.ОпределитьСоответствиеАдресаКЛАДРу(СтруктураПроверки, УказанныйИндекс, НазваниеРегиона,НазваниеРайона, 
...
//
// Возвращаемое значение:
//	Неопределено или Структура - Структура полей по найденому адресному элементу (см. функцию "АдресныйКлассификатор.ПолучитьПустуюСтруктуруАдреса()")
//
Функция ВернутьСтрокуАдресногоКлассификатораПоАдреснымЭлементам(Знач НазваниеРегиона, Знач НазваниеРайона,
	...
	СтандартныеПодсистемыПереопределяемый.ОпределитьСтрокуАдресногоКлассификатораПоАдреснымЭлементам(СтруктураАдресногоКлассификатора, НазваниеРегиона, НазваниеРайона,
