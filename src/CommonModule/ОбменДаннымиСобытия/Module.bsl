...
Процедура МеханизмРегистрацииОбъектов(ИмяПланаОбмена,
	...
	Если Не ОбменДаннымиПовтИсп.АвтоРегистрацияРазрешена(ИмяПланаОбмена, ОбъектМетаданных.ПолноеИмя()) Тогда
		...
		СтандартныеПодсистемыПереопределяемый.ПослеОпределенияПолучателей(Объект, МассивУзловРезультат, ИмяПланаОбмена);
...
Процедура ПередУдалениемУзлаПланаОбмена(Источник, Отказ) Экспорт
	
	Если ОбщегоНазначенияПовтИсп.ДоступноИспользованиеРазделенныхДанных() Тогда
		
		РегистрыСведений.РезультатыОбменаДанными.ПередУдалениемУзлаПланаОбмена(Источник.Ссылка);
