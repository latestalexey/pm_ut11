...
Функция ПараметрыРаботыКлиентаПриЗапуске() Экспорт
	...
	// Устарела, используется ОбщегоНазначенияПереопределяемый.ПараметрыРаботыКлиентаПриЗапуске()
	Возврат Параметры;
...
Функция ПараметрыРаботыКлиента() Экспорт
	...
	Параметры = Новый Структура();
	// Устарела, используется ОбщегоНазначенияПереопределяемый.ПараметрыРаботыКлиента()
	Возврат Параметры;
...
Функция ПараметрыРаботыКлиентаПриЗавершении() Экспорт
	...
	Параметры = Новый Структура();
	// Устарела, используется ОбщегоНазначенияПереопределяемый.ПараметрыРаботыКлиентаПриЗавершении()
	Возврат Параметры;
...
Процедура ПолучитьМинимальноНеобходимуюВерсиюПлатформы(ПараметрыПроверки) Экспорт
	// Устарела, используется ОбщегоНазначенияПереопределяемый.ПолучитьМинимальноНеобходимуюВерсиюПлатформы()
КонецПроцедуры	
