...
Функция ПроверитьСоответствиеАдресаКЛАДРу(Знач УказанныйИндекс = "", Знач НазваниеРегиона = "", Знач НазваниеРайона = "", 
	...
	Если Не ПустаяСтрока(УказанныйИндекс) Тогда
		...
		КонецЕсли;
	КонецЕсли;	СтруктураПроверки.Вставить("ЕстьОшибки", ЕстьОшибки);
...
Функция ВернутьСтруктуруОграниченийПоРодителю(Знач НазваниеРегиона, Знач НазваниеРайона, Знач НазваниеГорода, 
	...
	РодительскийЭлемент = ВернутьСтруктуруАдресногоКлассификатораПоАдреснымЭлементам(НазваниеРегиона, НазваниеРайона
	, НазваниеГорода, НазваниеНаселенногоПункта, НазваниеУлицы);
...
//
// Возвращаемое значение:
//  Структура полей по найденому адресному элементу (см. функцию "ПолучитьПустуюСтруктуруАдреса()")
//
Функция ВернутьСтруктуруАдресногоКлассификатораПоАдреснымЭлементам(Знач НазваниеРегиона, Знач НазваниеРайона,
