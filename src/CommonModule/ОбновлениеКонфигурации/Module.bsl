...
Процедура ЗавершитьОбновление(Знач РезультатОбновления, Знач ЭлектроннаяПочта, Знач ИмяАдминистратораОбновления) Экспорт
	...
	Если РезультатОбновления = Ложь Тогда
		ОбновлениеИнформационнойБазы.СнятьПризнакНеобходимостиОбновленияКонфигурацииИнформационнойБазы();
	КонецЕсли;
	
	СтандартныеПодсистемыПереопределяемый.ПослеЗавершенияОбновления();
