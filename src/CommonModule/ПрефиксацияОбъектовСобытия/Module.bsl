...
Процедура УстановитьПрефикс(Источник, Префикс, УстановитьПрефиксИнформационнойБазы, УстановитьПрефиксОрганизации)
	...
	Если УстановитьПрефиксИнформационнойБазы
		...
		ПрефиксИнформационнойБазы = СтандартныеПодсистемыПереопределяемый.ПрефиксИнформационнойБазы();
...
Функция ИмяРеквизитаОрганизация(Объект) Экспорт
	...
	Если ТипЗнч(Объект) = Тип("Строка") Тогда
		...
		Объект = Метаданные.НайтиПоПолномуИмени(Объект);
		
	КонецЕсли;
	
	СтрокаТаблицы = ПрефиксацияОбъектовПовтИсп.ПрефиксообразующиеРеквизиты().Найти(Объект, "Объект");
	
	Если СтрокаТаблицы <> Неопределено Тогда
		
		Возврат СтрокаТаблицы.Реквизит;
