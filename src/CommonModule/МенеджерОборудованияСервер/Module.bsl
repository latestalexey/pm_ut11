...
Функция СформироватьТаблицуТоваров(ДанныеЗагрузки) Экспорт
	...
	Для Каждого Позиция Из ДанныеЗагрузки  Цикл
		...
		ЗаписьXML.ЗаписатьАтрибут("Name", Позиция[1].Значение);
		ЗаписьXML.ЗаписатьАтрибут("UnitOfMeasurement", Позиция[2].Значение);
		ЗаписьXML.ЗаписатьАтрибут("CharacteristicOfNomenclature", Позиция[3].Значение);
		ЗаписьXML.ЗаписатьАтрибут("SeriesOfNomenclature", Позиция[4].Значение);
		ЗаписьXML.ЗаписатьАтрибут("Quality", Позиция[5].Значение);
