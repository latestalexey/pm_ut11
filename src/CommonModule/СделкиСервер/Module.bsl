...
Процедура ЗакрытьСтатистику(Сделка, Этап) Экспорт
...
Процедура СформироватьОтчет(ДокументРезультат, ДанныеРасшифровки, ОтчетОбъект, СтандартнаяОбработка, ВнешниеНаборыДанных = Неопределено, СхемаКомпоновкиДанных = Неопределено, ВыводитьШапкуНаВсехСтраницах = истина, ВыводитьЗаголовок = истина) Экспорт 
	...
	КонецЕсли;
	МакетКомпоновки = КомпоновщикМакета.Выполнить(СхемаКомпоновкиДанных, ОтчетОбъект.КомпоновщикНастроек.ПолучитьНастройки(), ДанныеРасшифровки);
