...
//
// Параметры:
//  ВладелецФайла                  - Ссылка - объект, к которому добавляется файл.
...
Функция КОбъектуМожноПрисоединятьФайлы(СсылкаНаОбъект) Экспорт
	
	ИмяХранилища = СсылкаНаОбъект.Метаданные().Имя + "ПрисоединенныеФайлы";
	
	СправочникПрисоединенныеФайлы = Метаданные.Справочники.Найти(ИмяХранилища);
	...
	Возврат СправочникПрисоединенныеФайлы <> Неопределено
	      ...
	      И ТипыХранимыхФайлов.СодержитТип(Тип("СправочникСсылка." + ИмяХранилища));
