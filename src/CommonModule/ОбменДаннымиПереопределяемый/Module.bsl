...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.АК_ОбменУТ_УПП_Заказы);//АСТЭК
	ОбменДаннымиПереопределяемыйУТУП.ПолучитьСписокПлановОбмена(ПланыОбменаПодсистемы);
...
Процедура РегистрацияИзмененийНачальнойВыгрузкиДанных(Знач Получатель, СтандартнаяОбработка, Отбор) Экспорт
	...
	ОбменДаннымиПереопределяемыйУТУП.РегистрацияИзмененияДляНачальнойВыгрузки(Получатель, СтандартнаяОбработка, Отбор);
