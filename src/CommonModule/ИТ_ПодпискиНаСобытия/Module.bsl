...
Процедура ПриЗаписиДокументов(Источник, Отказ) Экспорт
	...
	Если ТипЗнч(Источник) = Тип("ДокументОбъект.ЗаказПоставщику") Тогда
		//для записанных документов с установленым номером документа поставщика
		Если ЗначениеЗаполнено(Источник.Ссылка) И 
			СокрЛП(Источник.НомерВходящегоДокумента) <> "" Тогда
