...
Процедура ПолучитьОбработчикиКаналовСообщений(Обработчики) Экспорт
	...
	// ПакетАдминистрированиеОбменаДаннымиУправление
	СообщенияВМоделиСервиса.ПолучитьОбработчикиКаналовСообщений(
		Обработчики,
		ОбменДаннымиВМоделиСервисаПовтИсп.ПакетАдминистрированиеОбменаДаннымиУправление(),
		ОбработчикСообщенийАдминистрированиеОбменаДаннымиУправление
	);
	
	// ПакетАдминистрированиеОбменаДаннымиКонтроль
	СообщенияВМоделиСервиса.ПолучитьОбработчикиКаналовСообщений(
		Обработчики,
		ОбменДаннымиВМоделиСервисаПовтИсп.ПакетАдминистрированиеОбменаДаннымиКонтроль(),
		ОбработчикСообщенийАдминистрированиеОбменаДаннымиКонтроль
	);
	
	// ПакетОбменДаннымиУправление
	СообщенияВМоделиСервиса.ПолучитьОбработчикиКаналовСообщений(
		Обработчики,
		ОбменДаннымиВМоделиСервисаПовтИсп.ПакетОбменДаннымиУправление(),
		ОбработчикСообщенийОбменДаннымиУправление
	);
	
	// ПакетОбменДаннымиКонтроль
	СообщенияВМоделиСервиса.ПолучитьОбработчикиКаналовСообщений(
		Обработчики,
		ОбменДаннымиВМоделиСервисаПовтИсп.ПакетОбменДаннымиКонтроль(),
		ОбработчикСообщенийОбменДаннымиКонтроль
	);
