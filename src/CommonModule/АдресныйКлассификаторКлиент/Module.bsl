...
#КонецЕсли
	...
	Если Результат.Значение.Количество() <> 0 Тогда
		...
		Если КоличествоОбновлений > 0 Тогда
			...
			Если КоличествоОбновлений > 5 Тогда
				Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Обнаружены обновления для адресных объектов (%1).'"), КоличествоОбновлений) 
					+ Символы.ПС;
			Иначе
				Текст = НСтр("ru = 'Обнаружены обновления следующих адресных объектов:'")
							+ Символы.ПС
							+ СписокСтрока;
			КонецЕсли;
...
Процедура ОчиститьКлассификатор() Экспорт
	...
	ОткрытьФормуМодально("РегистрСведений.АдресныйКлассификатор.Форма.ОчисткаАдресногоКлассификатора");
