...
// Регистрирует параметры подсистемы, необходимые для работы клиентского кода конфигурации.
//
// Параметры:
//   Параметры (Структура) см. описание функции ДобавитьПараметрыРаботыКлиентскойЛогикиСтандартныхПодсистем
//   общего модуля СтандартныеПодсистемыПереопределяемый.
//
