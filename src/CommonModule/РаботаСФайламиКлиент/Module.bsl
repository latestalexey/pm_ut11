...
Процедура ОткрытьФормуНастройкиСканирования(Модально = Ложь) Экспорт
...
Процедура ОткрытьФормуНастройкиРабочегоКаталога(Модально = Ложь) Экспорт
	
	Если Модально Тогда
		ОткрытьФормуМодально("ОбщаяФорма.НастройкаЛокальногоКэшаФайлов");
	Иначе
		ОткрытьФорму("ОбщаяФорма.НастройкаЛокальногоКэшаФайлов");
	КонецЕсли;
