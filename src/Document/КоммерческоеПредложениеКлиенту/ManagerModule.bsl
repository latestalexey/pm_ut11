...
Функция ПечатьКоммПредложения(МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого СсылкаНаОбъект из МассивОбъектов Цикл
		...
		Запрос.Текст ="ВЫБРАТЬ
		              ...
		              |	И НЕ Таблица.Номенклатура В (ЗНАЧЕНИЕ(Справочник.Номенклатура.АК_Доставка), ЗНАЧЕНИЕ(Справочник.Номенклатура.АК_Монтаж))
		              |
		              |ОБЪЕДИНИТЬ ВСЕ
		              |
		              |ВЫБРАТЬ
		              ...
		              |	Таблица.Ссылка = &Ссылка
		              |	И Таблица.Активность
		              |	И Таблица.Номенклатура В (ЗНАЧЕНИЕ(Справочник.Номенклатура.АК_Доставка), ЗНАЧЕНИЕ(Справочник.Номенклатура.АК_Монтаж))
		              |;
		              |
		              |////////////////////////////////////////////////////////////////////////////////
		              |ВЫБРАТЬ
