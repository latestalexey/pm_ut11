...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для каждого ТекСтрока Из ТабНоменклатуры Цикл
		текАртикул = СтрЗаменить(ТекСтрока.Номенклатура.Артикул,"*","");
		ТекСтрока.Артикул = Лев(текАртикул, 3) + "_" + Сред(текАртикул, 5);
	КонецЦикла;
	...
	Пока ВыборкаДок.Следующий() Цикл
		...
		текАртикул = СтрЗаменить(ВыборкаДок.Номенклатура.Артикул,"*","");
		НовСтрока.Группа = Сред(текАртикул, 4, 1);
		...
		Пока Выборка.Следующий() Цикл
			...
			текАртикул = СтрЗаменить(Выборка.Артикул,"*","");
			НовСтрокаП.Группа = Сред(текАртикул, 4, 1);
		КонецЦикла;
	КонецЦикла;
