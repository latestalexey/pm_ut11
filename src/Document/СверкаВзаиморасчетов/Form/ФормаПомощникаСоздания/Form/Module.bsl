...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступноСохранениеДанныхПользователя = Пользователи.РолиДоступны("СохранениеДанныхПользователя");
...
///////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ЭЛЕМЕНТОВ ТАБЛИЦЫ ФОРМЫ ТАБЛИЦАРАСЧЕТОВ
...
///////////////////////////////////////////////////////////////////////////////
// Обработчики первого шага помощника
...
Процедура ЗаполнитьТаблицуРасчетовСервер()
	...
	|ГДЕ
	|	РасчетыСКлиентамиОбороты.СуммаПриход <> 0 ИЛИ РасчетыСКлиентамиОбороты.СуммаРасход <> 0
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|ГДЕ
	|	РасчетыСПоставщикамиОбороты.СуммаПриход <> 0 ИЛИ РасчетыСПоставщикамиОбороты.СуммаРасход <> 0
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// Обработчики второго шага помощника
...
///////////////////////////////////////////////////////////////////////////////
// Обработчики третьего шага помощника
...
Процедура УправлениеКнопкамиПодвал()
	...
	ИначеЕсли Элементы.СтраницыПомощника.ТекущаяСтраница = Элементы.СтраницаФинальная Тогда
		...
		Иначе
			Элементы.Далее.Заголовок = "Создать";
