...
Процедура ЗаполнитьТоварыПоЗаказуКлиента()
	...
	|	Товары.Упаковка       КАК Упаковка,
	|	ВЫБОР
	|		КОГДА ЗаказанныеТовары.КоличествоУпаковок ЕСТЬ NULL ТОГДА
	|			Товары.КоличествоУпаковок
	|		ИНАЧЕ
	|			Товары.КоличествоУпаковок - ЗаказанныеТовары.КоличествоУпаковок
	|	КОНЕЦ КАК КоличествоУпаковок,
	|	ВЫБОР
	|		КОГДА ЗаказанныеТовары.Количество ЕСТЬ NULL ТОГДА
	|			Товары.Количество
	|		ИНАЧЕ
 ...
 //   АК_Сделка АК_ЗаказКлиента    АК_ДатаОтгрузки  АК_ЗаказКлиентаКодСтроки	
	...
	|				ИЛИ Партнеры.Партнер = Партнеры.Партнер2 ТОГДА
	|
	|			Партнеры.Партнер
	|
	|		ИНАЧЕ ВЫБОР
	|				КОГДА Партнеры.Партнер1 = Партнеры.Партнер2 ТОГДА
	|
	|					Партнеры.Партнер1
	|
	|			КОНЕЦ
	...
	СвойствоПоставщик = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию("Производитель");
