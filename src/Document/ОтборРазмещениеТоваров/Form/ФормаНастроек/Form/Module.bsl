...
Процедура ЗакрытьССохранением(Команда)
	...
	Если Элементы.НастройкиЗаданияНаОтбор.Видимость Тогда
		...
		Если НастройкаФормированияПоРабочимУчасткам = "ПоОдномуРабочемуУчастку" 
			...
			ТекстСообщения = НСтр("ru='Поле ""%РабочийУчасток%"" не заполнено.'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%РабочийУчасток%","Рабочий участок");
	...
	Если Элементы.НастройкиЗаданияНаОтбор.Видимость Тогда
		...
		Если ОграничиватьПоВесу
			...
			ТекстСообщения = НСтр("ru='Поле ""%ОграничениеПоВесу%"" не заполнено.'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%ОграничениеПоВесу%","Ограничение по весу");
		...
		Если ОграничиватьПоОбъему
			...
			И (Не НастройкаФормированияПоРабочимУчасткам = "СРазбиениемПоРабочимУчасткам") Тогда
			ТекстСообщения = НСтр("ru='Поле ""%ОграничениеПоОбъему%"" не заполнено.'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%ОграничениеПоОбъему%","Ограничение по объему");
	...
	Если Элементы.ГруппаИсполнитель.Видимость 
		...
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%Исполнитель%","Исполнитель");
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("ФормаОтборРазмещениеФормаНастроекНастройкиФормы"+ВладелецНастроек+Операция+ИдентификаторСкладаПомещения, , ПараметрыЗакрытия);
