...
Функция ПолучитьСтруктуруДанных(СсылкаНаОбъект)
	...
	Если Выборка.Следующий() Тогда
		...
		//ака
		СтруктураРезультата.Вставить("СуммаДоговора","");
		СтруктураРезультата.Вставить("СуммаДоговораЦифры","");
		...
		Если ПроцентПредоплаты = 100 Тогда
			...
			СтруктураРезультата.СуммаДоговораЦифры =  Формат(СуммаДоговора, "ЧЦ=15; ЧДЦ=2");
			СтруктураРезультата.СуммаДоговора =  РаботаСКурсамиВалют.СформироватьСуммуПрописью(СуммаДоговора, Соглашение.Валюта);
...
Функция ПолучитьСсылкуНаФайлДоговора()
	Возврат Справочники.Файлы.НайтиПоНаименованию("договор_доставка_Румед_Редакция");
КонецФункции
