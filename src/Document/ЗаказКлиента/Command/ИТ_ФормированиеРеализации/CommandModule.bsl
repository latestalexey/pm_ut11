...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ОткрытьФорму("Документ.РеализацияТоваровУслуг.Форма.ФормаДокумента", 
       Новый Структура("Основание", Новый Структура("ДокументОснование, ДатаОтгрузки,ПоСтавкамНДС,СтавкаНДС", ПараметрКоманды,ТекущаяДата(),Истина,ТекСтавка.Значение)),,Новый УникальныйИдентификатор);
