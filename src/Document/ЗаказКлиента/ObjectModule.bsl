...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Поиск = Новый СписокЗначений;
	Поиск.Добавить(Справочники.Номенклатура.АК_Доставка);

	Если АК_УслугиДополнительные.Найти(Справочники.Номенклатура.АК_Доставка) <> Неопределено или
		АК_УслугиДополнительные.Найти(Справочники.Номенклатура.АК_ДоставкаАгент) <> Неопределено или
		АК_УслугиДополнительные.Найти(Справочники.Номенклатура.АК_ДоставкаКлиент) <> Неопределено ТОГДА
		ЕстьДоставка = ИСТИНА;
	ИНАЧЕ
		ЕстьДоставка = Ложь;
	КонецЕсли;	
