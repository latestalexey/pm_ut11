...
Функция ПолучитьДанныеДляПечатнойФормыТОРГ12(ПараметрыПечати, МассивОбъектов) Экспорт 
	...
	|	ВЫБОР
	|		КОГДА НЕ &ВыводитьБазовыеЕдиницыИзмерения
	|			ТОГДА ТаблицаТоваров.СуммаБезНДС / ВЫБОР когда ТаблицаТоваров.КоличествоУпаковок=0 Тогда 1 Иначе ТаблицаТоваров.КоличествоУпаковок Конец
	|		ИНАЧЕ ТаблицаТоваров.СуммаБезНДС / ВЫБОР когда ТаблицаТоваров.Количество=0 Тогда 1 Иначе ТаблицаТоваров.КоличествоУпаковок Конец
	|	КОНЕЦ КАК Цена,
