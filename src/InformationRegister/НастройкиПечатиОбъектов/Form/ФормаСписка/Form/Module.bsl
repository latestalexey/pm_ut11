...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ЭЛЕМЕНТОВ ТАБЛИЦЫ ФОРМЫ НАСТРОЙКИ ПЕЧАТИ ОБЪЕКТОВ
...
Процедура Добавить(Команда)
	...
	ОткрытьФормуМодально("РегистрСведений.НастройкиПечатиОбъектов.ФормаЗаписи");
...
Процедура Удалить(Команда)
	...
	Если ТекущиеДанные = Неопределено Тогда
		Предупреждение(НСтр("ru = 'Укажите настройку печати для удаления'"));
		Возврат;
	КонецЕсли;
	
	Если ТекущиеДанные.ИндексКартинки = 1 Тогда
		Предупреждение(НСтр("ru = 'Невозможно удалить группировку'"));
		Возврат;
	КонецЕсли;
	...
	ОтветНаВопрос = Вопрос(НСтр("ru = 'Удалить настройку печати?'"), СписокКнопок);
