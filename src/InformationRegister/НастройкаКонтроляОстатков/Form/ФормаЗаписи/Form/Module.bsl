...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступностьПолей = Запись.ВариантКонтроля = Перечисления.ВариантыКонтроля.ОстаткиСУчетомГрафика;
	Элементы.СрокПоставки.Доступность = ДоступностьПолей;
	Элементы.ГраницаГрафикаДоступности.Доступность = ДоступностьПолей;
...
Процедура ВариантКонтроляПриИзменении(Элемент)
	...
	ДоступностьПолей = Запись.ВариантКонтроля = ПредопределенноеЗначение("Перечисление.ВариантыКонтроля.ОстаткиСУчетомГрафика");
	Элементы.СрокПоставки.Доступность = ДоступностьПолей;
	Элементы.ГраницаГрафикаДоступности.Доступность = ДоступностьПолей;
