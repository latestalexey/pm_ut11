...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ДатыЗапретаЗагрузкиДанных Тогда
		...
		Команды.ДатыЗапретаПоПользователям.Заголовок                    = НСтр("ru = 'Даты запрета по информационным базам'");
		Команды.ДатыЗапретаПоПользователям.Подсказка                    = НСтр("ru = 'Даты запрета загрузки данных
		                                                                             |по информационным базам и программам.'");
		Команды.ДатыЗапретаПоРазделамОбъектамДляПользователей.Заголовок = НСтр("ru = 'Даты запрета по разделам и объектам для информационных баз'");
		...
		//
		Элементы.ПользователиПолноеПредставление.Заголовок = НСтр("ru = 'Программа: информационная база'");
		//
