...
Процедура ОбновитьЗначенияРеквизитаДопУпорядочивания(ПараметрыОтбора)
	...
	|	ВариантыОбеспеченияТоварами.УдалитьСрокТранспортировки КАК УдалитьСрокТранспортировки,
	|	ВариантыОбеспеченияТоварами.УдалитьКалендарь КАК УдалитьКалендарь,
	|	ВариантыОбеспеченияТоварами.РеквизитДопУпорядочивания КАК РеквизитДопУпорядочивания,
	|	ВЫБОР
