...
Функция ФормаВыполненияЗадачи(ЗадачаСсылка, ТочкаМаршрутаСсылка) Экспорт
	...
	ИмяФормы = "БизнесПроцесс.акСделкаСДилерами.Форма.ФормаБизнесПроцесса";
...
Функция ОписаниеТочки(ТочкаМаршрутаБизнесПроцесса) Экспорт
	...
	Если ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.акСделкаСДилерами.ТочкиМаршрута.СоставитьКоммерческоеПредложение Тогда
		Возврат НСтр("ru=' - подготовте комерческое предложение;'"
		);
	ИначеЕсли ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.акСделкаСДилерами.ТочкиМаршрута.ОтправитьПочту Тогда
		Возврат НСтр(
			"ru=' - отправте коммерческое предложение'"
		);
	ИначеЕсли ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.акСделкаСДилерами.ТочкиМаршрута.Позвонить Тогда
		Возврат НСтр(
			"ru=' - позвонить по коммерческому предложению'"
		);
	ИначеЕсли ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.акСделкаСДилерами.ТочкиМаршрута.СогласоватьКоммерческоеПредложение Тогда
		Возврат НСтр(
			"ru=' - согласуйте коммерческое предложение'"
		);
	ИначеЕсли ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.акСделкаСДилерами.ТочкиМаршрута.СформироватьЗаказ Тогда
		Возврат НСтр(
			"ru=' - сформируйте заказ'"
		);
	ИначеЕсли ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.акСделкаСДилерами.ТочкиМаршрута.ОтправитьЗаказПоПочте Тогда
		Возврат НСтр(
			"ru=' - Отправте заказ по почте'"
		);
	ИначеЕсли ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.акСделкаСДилерами.ТочкиМаршрута.ПозвонитьПослеЗаказа Тогда
		Возврат НСтр(
			"ru=' - Позвоните подтвертие заказ'"
		);
	ИначеЕсли ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.акСделкаСДилерами.ТочкиМаршрута.ОбеспечитьЗаказ Тогда
		Возврат НСтр(
			"ru=' - Обеспечте заказ'"
		);
