...
Функция ФормаВыполненияЗадачи(ЗадачаСсылка, ТочкаМаршрутаСсылка) Экспорт
    Если ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаМонтаж.ТочкиМаршрута.УтверждениеЗаказа тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаМонтаж.Форма.УтверждениеЗаказа";
	ИНачеЕсли ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаМонтаж.ТочкиМаршрута.ОбработкаОтказа тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаМонтаж.Форма.ОбработкаОтказа";
	ИНачеЕсли ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаМонтаж.ТочкиМаршрута.СформироватьЗаказНаДоставку тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаМонтаж.Форма.ЗаказыПостащика";
	ИНачеЕсли ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаМонтаж.ТочкиМаршрута.ПолучитьДокументы тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаМонтаж.Форма.ЗаказыПостащика";
	ИНачеЕсли ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаМонтаж.ТочкиМаршрута.ЗакрытьПроект тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаМонтаж.Форма.ЗаказыПостащика";
	Иначе
		ИмяФормы = "БизнесПроцесс.акЗаказыНаМонтаж.Форма.Напоминание";
	КонецЕсли;
