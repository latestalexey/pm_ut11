...
Функция ФормаВыполненияЗадачи(ЗадачаСсылка, ТочкаМаршрутаСсылка) Экспорт
    Если ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаДоставку.ТочкиМаршрута.УтверждениеЗаказа тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаДоставку.Форма.УтверждениеЗаказа";
	ИНачеЕсли ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаДоставку.ТочкиМаршрута.ОбработкаОтказа тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаДоставку.Форма.ОбработкаОтказа";
	ИНачеЕсли ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаДоставку.ТочкиМаршрута.СформироватьЗаказНаДоставку тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаДоставку.Форма.ЗаказыПостащика";
	ИНачеЕсли ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаДоставку.ТочкиМаршрута.ПолучитьДокументы тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаДоставку.Форма.ЗаказыПостащика";
	ИНачеЕсли ТочкаМаршрутаСсылка = БизнесПроцессы.акЗаказыНаДоставку.ТочкиМаршрута.ЗакрытьПроект тогда
		ИмяФормы = "БизнесПроцесс.акЗаказыНаДоставку.Форма.ЗаказыПостащика";
	иначе
		ИмяФормы = "БизнесПроцесс.акЗаказыНаДоставку.Форма.Напоминание";
	КонецЕсли;
