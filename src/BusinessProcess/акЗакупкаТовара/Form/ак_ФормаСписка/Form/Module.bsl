...
Процедура УстановитьОтбор()
	...
	ПараметрыОтбора.Вставить("ПоПредмету", ПоПредмету);
	ПараметрыОтбора.Вставить("ПоПроекту", ПоПроекту);
	ПараметрыОтбора.Вставить("ПоНомеру", ПоНомеру);
...
Процедура УстановитьОтборСписка(ПараметрыОтбора)
	...
	Если ПараметрыОтбора["ПоПредмету"].Пустая() Тогда                           
		ОбщегоНазначенияКлиентСервер.УдалитьЭлементыГруппыОтбора(Список.Отбор, "Предмет");
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		Список.Отбор, "Предмет", ПараметрыОтбора["ПоПредмету"]);
	КонецЕсли;
	
	Если ПараметрыОтбора["ПоПроекту"].Пустая() Тогда
		ОбщегоНазначенияКлиентСервер.УдалитьЭлементыГруппыОтбора(Список.Отбор, "Проект");
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		Список.Отбор, "Проект", ПараметрыОтбора["ПоПроекту"]);
	КонецЕсли;
	
	Если ПараметрыОтбора["ПоНомеру"] = "" Тогда
		ОбщегоНазначенияКлиентСервер.УдалитьЭлементыГруппыОтбора(Список.Отбор, "НомерЗаказаКлиента");
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		Список.Отбор, "НомерЗаказаКлиента", ПараметрыОтбора["ПоНомеру"],ВидСравненияКомпоновкиДанных.Содержит);
	КонецЕсли;
...
&НаКлиенте
Процедура ПоНомеруПриИзменении(Элемент)
	УстановитьОтбор();
КонецПроцедуры
