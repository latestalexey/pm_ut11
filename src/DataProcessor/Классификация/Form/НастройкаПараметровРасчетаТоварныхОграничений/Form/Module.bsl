...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.ДекорацияРасчетТоварныхОграниченийОписание.Заголовок = НСтр("ru = 'По данным за период: '") + ОписаниеНастройки(ПериодРасчетаТоварныхОграничений, КоличествоПериодовРасчетаТоварныхОграничений);
...
Процедура OK(Команда)
	...
	Если ПроверитьЗаполнение() Тогда
		...
		КодВозврата.Вставить("ВыполнятьРасчетТоварныхОграниченийПоКоличествуПродаж", ВыполнятьРасчетТоварныхОграниченийПо);
