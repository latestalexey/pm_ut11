...
Процедура НастройкаABCXYZКлассификацияПолныеВозможности(Команда)
	...
	КодВозврата = ОткрытьФормуМодально(ПолноеИмя + ".Форма.НастройкаПараметровКлассификацииКлиентов");
...
Процедура ОчиститьABCКлассификациюПолныеВозможности(Команда)
	...
	КодВозврата = Вопрос(НСтр("ru = 'Вся информация об ABC классификации клиентов будет очищена. Продолжить?'"), РежимДиалогаВопрос.ОКОтмена);
...
Процедура ОчиститьXYZКлассификациюПолныеВозможности(Команда)
	...
	КодВозврата = Вопрос(НСтр("ru = 'Вся информация об XYZ классификации клиентов будет очищена. Продолжить?'"), РежимДиалогаВопрос.ОКОтмена);
