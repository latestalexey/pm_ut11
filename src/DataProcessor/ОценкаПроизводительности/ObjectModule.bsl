...
// Возвращаемое значение:
//  Булево - 
//  	Истина, параметры расчитаны
//  	Ложь, параметры не расчитаны
//
...
// Процедура расчитывает итоговое значение APDEX
//
// Параметры:
//  ТаблицаКлючевыхОпераций - ТаблицаЗначений, результат запроса расчитавшего APDEX
//
