...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ЭЛЕМЕНТОВ ТАБЛИЦЫ ФОРМЫ СКЛАДСКИЕ ЯЧЕЙКИ
...
Процедура Печать(Команда)
	...
	ПараметрКоманды.Добавить(ПолучитьПараметрыДляСкладскихЯчеек()); // В дальнейшем будем обращаться к объекту через ПараметрКоманды[0]
