...
Процедура ЗабылиПароль(Команда)
	...
	СтандартныеПодсистемыКлиентПереопределяемый.ПриОткрытииИнструкцииКакИзменитьПарольСинхронизацииДанных();
...
Процедура СценарийОбменаЧерезВебСервис()
	...
	ТаблицаПереходовНоваяСтрока(1, "ОжиданиеПроверкиПодключения",,,,,, Истина, "ОжиданиеПроверкиПодключенияПарольЗадан_ОбработкаДлительнойОперации");
