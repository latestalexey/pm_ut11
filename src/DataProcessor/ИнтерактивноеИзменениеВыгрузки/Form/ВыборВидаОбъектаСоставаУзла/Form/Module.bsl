...
Процедура ДобавитьВсеОбъекты(ВсеСсылочныеДанныеУзла, СтрокиПриемника)
    ...
    ГруппаДокументы.ПолноеИмяМетаданных = ЭтотОбъект.ИдентификаторВсехДокументов();
    ...
    ГруппаСправочники.ПолноеИмяМетаданных = ЭтотОбъект.ИдентификаторВсехСправочников();
