...
//
Функция ФоноваяРегистрацияДополнительныхИзменений(АдресОбъекта) Экспорт
    
    Если ОбщегоНазначения.ИнформационнаяБазаФайловая() Тогда
        ЗарегистрироватьДополнительныеИзменения(АдресОбъекта);
        Возврат Неопределено;
    КонецЕсли;            
    
    ПараметрыЗадания = Новый Массив;
    ПараметрыЗадания.Добавить(ЭтотОбъектВСтруктуру());
    ПараметрыЗадания.Добавить(АдресОбъекта);
...
Функция ФоновоеФормированиеДереваЗначений(АдресРезультата, СписокИменМетаданных=Неопределено) Экспорт
    ...
    Если ОбщегоНазначения.ИнформационнаяБазаФайловая() Тогда
        АдресРезультата = ПоместитьВоВременноеХранилище(
            СформироватьДеревоЗначений(СписокИменМетаданных)
        );
        Возврат Неопределено;
    КонецЕсли;            
...
//
//  Производит дополнительную регистрацию.
//
//  Параметры:
//      АдресОбъекта: адрес временного хранилища с параметрами дополнительной регистрации
//
Процедура ЗарегистрироватьДополнительныеИзменения(АдресОбъекта) Экспорт
